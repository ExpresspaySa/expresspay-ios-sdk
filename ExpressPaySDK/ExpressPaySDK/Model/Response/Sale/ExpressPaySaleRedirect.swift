...
public struct ExpressPaySaleRedirect: DetailsExpressPayResultProtocol {
    ...
    public let redirectParams: ExpressPaySaleRedirectBody
...
extension ExpressPaySaleRedirect: Decodable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        redirectParams = try container.decode(ExpressPaySaleRedirectBody.self, forKey: .redirectParams)
